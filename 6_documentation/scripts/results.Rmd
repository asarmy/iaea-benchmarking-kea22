...
Three Benchmarking cases were provided by the IAEA based on recent surface-
rupturing earthquakes that produced distributed or secondary ruptures:
...
As described in **Model Overview**, the KEA22 FDM estimates the *aggregated 
...
The sections below present the results of the PFDHAs using the KEA22 FDM. The
model was implemented as recommended in the KEA22 technical report ([https://doi.org/10.34948/N3X59H](https://doi.org/10.34948/N3X59H)), with key
aspects of the implementation summarized above in **Model Implementation**. The
results are presented in three ways for both the *mean model* and the *full 
model* (which are defined in **Model Implementation**):
